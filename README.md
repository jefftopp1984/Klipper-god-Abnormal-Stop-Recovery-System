...
*** IMPORTANT: After placing the macros in the ab_stop_recover.cfg, change the coordinates toward the end of the _RESUME_INT macro to be the center of your bed. The default values are for a LARGE CR-M4 so they will need to be updated to match YOUR bed size. You will also need to update the max_z value in the _LIFT_Z_RESUME macro at the end of the ab_stop_recover.cfg macros.
